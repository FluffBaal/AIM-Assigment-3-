...
from backend.app.api.endpoints import upload, chat, health, monitoring, errors, stateless  # noqa: E402
...
router.include_router(stateless.router, prefix="/stateless", tags=["stateless"])